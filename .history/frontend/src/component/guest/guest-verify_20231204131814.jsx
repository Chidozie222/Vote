            ...
            <div className="sixth"></div>
                 <div className="guest_verify_form">
                    ...
                    <div className="Container">
                        <h1>Step2: Fill up the form with your detail</h1>
                        <hr />
                        <form>
                            ...
                            <p id="error2"></p>
                            <button type="submit" onClick={guest_verify}>Verify</button>
                            <p className="resend">your otp code will expire after 2mins, click here to resend the otp</p>
                            <br/>
                            <button type="btn" className="resend_button" onClick={sent_otp}>resend</button>
                        </form>
                    </div>
                 </div> 
        </div>
