        ...
        if(setting.status === 'ok') {
            return(
                ...
                <label id="Name">
                            ...
                            <br/>
                            <input type="text" name="Name" id="Name_setting" value={setting.data.Username} disabled/>
                            <label id="Email">
                            Email:
                            </label>
                            <br/>
                    <input type="email" name="Email" id="Email_setting" value={setting.data.Useremail}  disabled/>
                    
                    <label id='PhoneNumber'>
                            Phone Number:
                            </label>
                            <br/>
                            <input type="PhoneNumber" name="PhoneNumber" id="PhoneNumber_setting" value={setting.data.PhoneNumber} disabled/>
                    </>
            )
        }
    }
        ...
        <div className="first"></div>
            ...
            <div className="setting">
                ...
                <div className="setting_file">
                    {photo_section()}
                    <div className="form_for_setting">
                        {setting_function()}
                    </div>
                </div>
                <center>
