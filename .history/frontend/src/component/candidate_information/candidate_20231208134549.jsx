...
const Candidate_information = () => {
    ...
    const button = (data) => {
        if (data.status === 'ok') {
            return(<div className="btn-controller">
...
<div id="devModal" className="modal fade" role="dialog">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button className="btn btn-success" data-dismiss="modal" onClick={candidate_function}>Save</button>
                        </div>
                    </div>
                </div>
            </div>
